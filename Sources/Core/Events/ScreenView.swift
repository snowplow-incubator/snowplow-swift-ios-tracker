...
public class ScreenView: SelfDescribingAbstract {
    ...
    @objc public class func stringWithScreenType(_ screenType: ScreenType) -> String? {
        let arr = [
            "Default",
            "Navigation",
            "TabBar",
