...
public class SelfDescribingJson: NSObject {
    ...
    /// - Returns: An SPSelfDescribingJson.
    @objc public convenience init(schema: String, andDictionary data: [String : NSObject]) {
    ...
    /// - Returns: An SPSelfDescribingJson.
    @objc public convenience init(schema: String, andPayload data: Payload) {
    ...
    /// - Returns: An SPSelfDescribingJson.
    @objc public convenience init(schema: String, andSelfDescribingJson data: SelfDescribingJson) {
        self.init(schema: schema, andData: data.getAsDictionary() as? NSObject)
    }
    ...
    @objc public func getAsDictionary() -> [String : NSObject]? {
        if let data {
            return [
