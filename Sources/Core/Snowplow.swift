...
public class Snowplow: NSObject {
    ...
    @objc public class func setup(remoteConfiguration: RemoteConfiguration, defaultConfiguration defaultBundles: [ConfigurationBundle]?, onSuccess: @escaping (_ namespaces: [String]?, _ configurationState: ConfigurationState) -> Void) {
    ...
    @objc public class func refresh(onSuccess: @escaping (_ namespaces: [String]?, _ configurationState: ConfigurationState) -> Void) {
    ...
    ///                collector.
    /// - Returns: The tracker instance created.
    @objc public class func createTracker(namespace: String, network networkConfiguration: NetworkConfiguration) -> TrackerController? {
        return createTracker(namespace: namespace, network: networkConfiguration, configurations: [])
    }
    ...
    @objc public class func setAsDefault(tracker trackerController: TrackerController?) -> Bool {
    ...
    @objc public class func removeAllTrackers() {
        objc_sync_enter(self)
        defaultServiceProvider = nil
    ...
    @objc class public var instancedTrackerNamespaces: [String] {
    ...
    class func createTrackers(configurationBundles bundles: [ConfigurationBundle]) -> [String] {
