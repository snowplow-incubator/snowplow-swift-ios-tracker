...
public class GlobalContextsConfiguration: Configuration, GlobalContextsConfigurationProtocol {
    @objc public var contextGenerators: [String : GlobalContext] = [:]

    @objc public func add(tag: String, contextGenerator generator: GlobalContext) -> Bool {
    ...
    @objc public func remove(tag: String) -> GlobalContext? {
