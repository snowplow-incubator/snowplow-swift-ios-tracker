...
public protocol SubjectConfigurationProtocol: AnyObject {
    ...
    @objc var networkUserId: String? { get set }
    /// The domain UserID.
    /// Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
    @objc var domainUserId: String? { get set }
    /// The user-agent.
    /// Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
    @objc var useragent: String? { get set }
    /// The IP address.
    /// Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
    @objc var ipAddress: String? { get set }
    /// The current timezone.
    @objc var timezone: String? { get set }
    /// The language set in the device.
    @objc var language: String? { get set }
    /// The screen resolution.
    @objc var screenResolution: SPSize? { get set }
    /// The screen viewport.
    /// Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
    @objc var screenViewPort: SPSize? { get set }
    /// The color depth.
    /// Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
    @objc var colorDepth: NSNumber? { get set }
    // MARK: - GeoLocation

    /// Latitude value for the geolocation context.
    @objc var geoLatitude: NSNumber? { get set }
    /// Longitude value for the geo context.
    @objc var geoLongitude: NSNumber? { get set }
    /// LatitudeLongitudeAccuracy value for the geolocation context.
    @objc var geoLatitudeLongitudeAccuracy: NSNumber? { get set }
    /// Altitude value for the geolocation context.
    @objc var geoAltitude: NSNumber? { get set }
    /// AltitudeAccuracy value for the geolocation context.
    @objc var geoAltitudeAccuracy: NSNumber? { get set }
    /// Bearing value for the geolocation context.
    @objc var geoBearing: NSNumber? { get set }
    /// Speed value for the geolocation context.
    @objc var geoSpeed: NSNumber? { get set }
    /// Timestamp value for the geolocation context.
    @objc var geoTimestamp: NSNumber? { get set }
}
...
public class SubjectConfiguration: Configuration, SubjectConfigurationProtocol {
    ...
    /// The domain UserID.
    /// Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
    @objc public var domainUserId: String?
    ...
    /// The screen resolution.
    @objc public var screenResolution: SPSize?

    /// The screen viewport.
    /// Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
    @objc public var screenViewPort: SPSize?

    /// The color depth.
    /// Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
    @objc public var colorDepth: NSNumber?
    ...
    // geolocation
    @objc public var geoLatitude: NSNumber?

    /// Longitude value for the geo context.
    @objc public var geoLongitude: NSNumber?

    /// LatitudeLongitudeAccuracy value for the geolocation context.
    @objc public var geoLatitudeLongitudeAccuracy: NSNumber?

    /// Altitude value for the geolocation context.
    @objc public var geoAltitude: NSNumber?

    /// AltitudeAccuracy value for the geolocation context.
    @objc public var geoAltitudeAccuracy: NSNumber?

    /// Bearing value for the geolocation context.
    @objc public var geoBearing: NSNumber?

    /// Speed value for the geolocation context.
    @objc public var geoSpeed: NSNumber?

    /// Timestamp value for the geolocation context.
    @objc public var geoTimestamp: NSNumber?
