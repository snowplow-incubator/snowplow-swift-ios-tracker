...
class TestTrackerConfiguration: XCTestCase {
    ...
    func testTrackerVersionSuffix() {
        ...
        let versionTracker = payload?.getAsDictionary()?["tv"] as? String
    ...
    func testGDPRConfiguration() {
        ...
        var contexts = payload?.getAsDictionary()?["co"] as? String
        ...
        contexts = payload?.getAsDictionary()?["co"] as? String
    ...
    func testAnonymisesUserIdentifiersIfAnonymousUserTracking() {
        ...
        guard let payload = events.first?.payload,
              let contexts = payload.getAsDictionary()?["co"] as? String else { return XCTFail() }
    ...
    func testTrackerReturnsTrackedEventId() {
        ...
        // Check eid field
        let trackedEventId = payload?.getAsDictionary()?["eid"] as? String
